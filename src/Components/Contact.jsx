...
const Contact = () => {
    ...
    const formSubmit = (e) => {
        e.preventDefault();
        alert(`My name is ${data.fullname}. My Mobile no is ${data.phone} and email is ${data.email} , Here is what to to say  ${data.msg}`)
    }
    return (
        <>
            <div className="my-3">
                        ...
                        <form onSubmit={formSubmit}>
                            ...
                            <div className="mb-3">
                                ...
                                <input type="number" className="form-control" id="exampleFormControlInput1"
                                    name="phone" value={data.phone} onChange={inputEvent} placeholder="Phone number" />
                            </div>
                            <div class="mb-3">
